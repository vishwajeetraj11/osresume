      ...
      <div className="landing-container bg-white">
        <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row">
          <div className="pl-10 lg:pl-0 h-2/4 lg:h-auto lg:w-3/6 flex flex-col justify-center">
            <h2 className="text-sm font-light uppercase" style={{ letterSpacing: '5.4px' }}>
              Oversimplifying
            </h2>
            <h1 className="text-7xl text-default font-medium">Resume</h1>
            <h3 className="text-2xl font-light tracking-wider text-default">Building Experience.</h3>
          </div>
          <div className="lg:w-3/6 grid items-center">
            <Image src="/landing.png" layout="responsive" height="70%" width="100%" />
          </div>
        </div>
      </div>
    </>
